...
def get_config():
    ...
    for nameval in config.items(get_service_name() or 'ReadsAlignmentUtils'):
        retconfig[nameval[0]] = nameval[1]
    return retconfig

config = get_config()

from ReadsAlignmentUtils.ReadsAlignmentUtilsImpl import ReadsAlignmentUtils  # noqa @IgnorePep8
impl_ReadsAlignmentUtils = ReadsAlignmentUtils(config)
...
class Application(object):
    ...
    def __init__(self):
        submod = get_service_name() or 'ReadsAlignmentUtils'
        ...
        self.rpc_service.add(impl_ReadsAlignmentUtils.validate_alignment,
                             name='ReadsAlignmentUtils.validate_alignment',
                             types=[dict])
        self.method_authentication['ReadsAlignmentUtils.validate_alignment'] = 'required'  # noqa
        self.rpc_service.add(impl_ReadsAlignmentUtils.upload_alignment,
